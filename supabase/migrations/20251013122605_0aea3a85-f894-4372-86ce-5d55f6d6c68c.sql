-- Ajouter la colonne order_number à la table vaccine_inventory
ALTER TABLE vaccine_inventory ADD COLUMN order_number integer;

-- Créer une séquence pour le numéro d'ordre
CREATE SEQUENCE IF NOT EXISTS vaccine_inventory_order_seq START 1;
