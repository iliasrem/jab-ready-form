...
time_slots AS (
  ...
  SELECT 
    ('09:15:00'::time + (n * interval '15 minutes'))::time as start_time,
    ('09:30:00'::time + (n * interval '15 minutes'))::time as end_time
  FROM generate_series(0, 10) n  -- 11 créneaux de 15 minutes
)
