...
BEGIN
  ...
  -- Groupes de doublons : meme nom, prenom (insensibles a la casse, espaces ignores)
  -- et meme date de naissance (deux dates vides sont considerees comme identiques)
